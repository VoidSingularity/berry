...
package net.mcberry.berry.loader;
...
public final class BerryLoader {
    ...
    public BerryLoader(String[] args) {
        BerryClassLoader loader = BerryClassLoader.getInstance();
        ...
        String mcmain = System.getProperty("berry.main");
        String moddir = null;
        int i;
        ...
        for (var mod : mods) {
            try {
                ...
                if (attr != null) {
                    loader.appendToClassPathForInstrumentation(container.filepath());
