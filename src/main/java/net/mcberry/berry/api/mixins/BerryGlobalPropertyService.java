...
public class BerryGlobalPropertyService implements IGlobalPropertyService {
    ...
    public <T> T getProperty(IPropertyKey key) {
        return (T) properties.get(((MixinStringPropertyKey) key).key);
    }

    @SuppressWarnings("unchecked")
    @Override
    public <T> T getProperty(IPropertyKey key, T fb) {
        return (T) properties.getOrDefault(((MixinStringPropertyKey) key).key, fb);
    }

    @Override
    public void setProperty(IPropertyKey key, Object value) {
        properties.put(((MixinStringPropertyKey) key).key, value);
    }

    @Override
    public String getPropertyString(IPropertyKey key, String fb) {
