...
package net.mcberry.berry.api.mixins;
...
import net.mcberry.berry.api.BuiltinAPIBootstrap;
import net.mcberry.berry.loader.classloading.BerryClassTransformer;
...
public class BerryMixinService implements IMixinService, IClassProvider, IClassBytecodeProvider {
    ...
    @Override
    public ClassNode getClassNode(String name, boolean rt, int flags) throws ClassNotFoundException, IOException {
        return getClassNode(name, flags);
    }
    ...
    @Override
    public ClassNode getClassNode(String name, boolean rt) throws ClassNotFoundException, IOException {
        return this.getClassNode(name, rt, 0);
    }

    /* As it is deprecated in 0.8 */
    @Override
    ...
    @Override
    public void checkEnv(Object bs) {
    }
    ...
    public IAdviceProvider getAdviceProvider() {
        return (requiredCompatibility, requiredCompatibilityString)
                -> "I don't know what to say, update your berry loader!";
    }
